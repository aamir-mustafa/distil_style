...
state_dict, params_ = load_test_ckpt('ckpts_encoder_new_idea_3_no_hist_Smaller_Net/Encoder_epoch_470.pt')
...
polynomial_matrix_used= 'New_Idea_Smaller_Net_Demo'
...
s1= st.slider("Attribute 1", min_value= 1.0, max_value=10.0, value= 3.0 ,step=1.0 )
s2= st.slider("Attribute 2", min_value= 1.0, max_value=10.0,  value= 8.0 , step=1.0 )
s3= st.slider("Attribute 3", min_value= 1.0, max_value=15.0, value= 1.0 , step=1.0 )
s4= st.slider("Attribute 4", min_value= 1.0, max_value=10.0,  value= 9.0 ,step=1.0 )
s5= st.slider("Attribute 5", min_value= 1.0, max_value=10.0, value= 8.0 , step=1.0 )
s6= st.slider("Attribute 6", min_value= 1.0, max_value=10.0,  value= 4.0 ,step=1.0 )
s7= st.slider("Attribute 7", min_value= 1.0, max_value=10.0,  value= 8.0 ,step=1.0 )
s8= st.slider("Attribute 8", min_value= 1.0, max_value=10.0,  value= 4.0 ,step=1.0 )
s9= st.slider("Attribute 9", min_value= 1.0, max_value=10.0,  value= 7.0 ,step=1.0 )
...
#    
    ...
    pred= torch.matmul(encoded_matrix, new/1000)
